...
<a target="_blank" href="https://itunes.apple.com/app/id<?php echo get_wpappninja_option('appstore_package', '');?>"><img width="139" border="0" src="<?php echo WPAPPNINJA_ASSETS_IMG_URL;?>appstore.png" /></a>
                ...
                <br/><br/>
<a style="font-size: 14px;border: 1px solid #f49c00;padding: 8px;color: #000000;text-decoration: none;border-radius: 4px;" href="https://wpmobile.app/" target="_blank"><?php _e('Update and files', 'wpappninja');?></a>
            ...
            <?php } elseif(get_wpappninja_option('appstore_package', '') == 'xxx') {
                ...
                <?php if(!defined('WPAPPNINJA_WHITE_LABEL')) { ?>
                <br/>
<a style="font-size: 14px;border: 1px solid #f49c00;padding: 8px;color: #000000;text-decoration: none;border-radius: 4px;" href="https://wpmobile.app/" target="_blank"><?php _e('Build the app', 'wpappninja');?></a>
