...
function _wpappninja_settings_menu() {
	...
	add_submenu_page( $slug, __('Preview', 'wpappninja'), __('Preview', 'wpappninja'), wpappninja_get_right("preview"), WPAPPNINJA_PREVIEW_SLUG, '_wpappninja_display_preview_page' );
